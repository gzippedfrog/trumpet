    <div class="mb-3 p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 <?= isset($isReply) ? 'ml-10' : '' ?>">
        <div class="text-gray-500">@<?= htmlspecialchars($post["author_username"]) ?></div>
        ...
        <div class="flex mt-3 gap-3">
            <?php if (isset($_SESSION['id'])) : ?>
                ...
                <?php if (!isset($isReply)) : ?>
                    <a href="/posts/create?parent_id=<?= $post['id'] ?>" class="flex items-center hover:text-blue-700 dark:text-white">
                        Reply
