<?php view('partials/head', ['title' => 'Register']) ?>
...
<div
    ...
    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form method="POST" action="/register" class="space-y-4 md:space-y-6">
            ...
            <button type="submit"
                class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
            <p class="text-gray-500 dark:text-gray-400">
                Already have an account? <a href="/login" class="text-blue-600 hover:underline dark:text-blue-500">Login
                    here</a>
            </p>
        </form>
    </div>
