<!-- Main modal -->
<div id="new-post-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button"
                ...
                data-modal-hide="new-post-modal">
                        ...
                        <?php if (flashed('errors')['text'] ?? false): ?>
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', (event) => {
                                    const modal = new Modal(document.getElementById('new-post-modal'));
                                    modal.show();
                                });
                            </script>
                        <?php endif; ?>
...
<!-- Modal toggle -->
<button data-modal-target="new-post-modal" data-modal-show="new-post-modal"
